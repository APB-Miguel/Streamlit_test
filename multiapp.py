...
class MultiApp:
    ...
    def run(self):
        ...
        with open(f'C:/users/usuario/python_course/projects/APB_OM/styles/style_APB.css') as f:
            st.markdown('<style>{}</style>'.format(f.read()), unsafe_allow_html=True)
            st.sidebar.image('python_course/projects/APB_OM/images/logo_APB_2.jpg', width=300)
